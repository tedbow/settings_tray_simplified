...
/**
 * @defgroup settings_tray_simple Settings Tray API
 * @{
 * Settings Tray API
 *
 ...
 *   block. See \Drupal\settings_tray_simple\Form\SystemBrandingOffCanvasForm which
 ...
 * @code
 * forms = {
 *   "settings_tray_simple" = "\Drupal\some_module\Form\MyBlockOffCanvasForm",
 * },
 * @endcode
 *
 ...
 * @endcode
 *
 * Finally, blocks that do not specify a settings_tray_simple form using the annotation
 ...
 * @code
 * forms = {
 *   "settings_tray_simple" = "\Drupal\system\Plugin\Block\SystemPoweredByBlock",
 * },
 * @endcode
 *
 ...
 *
 * @see settings_tray_simple_block_alter()
 * @see \Drupal\Tests\settings_tray_simple\Functional\SettingsTrayBlockTest::testPossibleAnnotations()
 *
 * @}
 */
